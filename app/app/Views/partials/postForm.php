        ...
        <form action="/post/postSave" method="POST" class="content-form-container">
            <div class="form-toolbar-wrapper">
                <div class="textarea-container">
                    <textarea name="text_content" id="textArea" rows="6" maxlength="260"
            ...
            <p class="characters-left input-feedback-info">Characters left: <span id="charactersRemaining">260</span>
            </p>
        </form>
    </div>
